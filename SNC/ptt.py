...
class PTT:
    ...
    Args:
        ...
        crawler_pages (int, optional): _description_. Defaults to 5.
        sleep (int, optional): _description_. Defaults to 5.
    ...
    .. code-block:: python
        ...
        ptt = SNC.PTT(board="Bank_Service", crawler_pages=10, sleep=0.5)
